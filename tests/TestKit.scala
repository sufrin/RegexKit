import sufrin.regex.{Match, PrettyPrint}
...
object TestKit {
  ...
  val text =
    """Et licet quocumque oculos flexeris feminas adfatim multas spectare cirratas, quibus, si nupsissent, per aetatem ter iam
  ...
  val programtext =
    """object TestKit {
       "a string with an \" embedded quote and \\"
  /** Uniform way of showing test results */
  implicit class Showable(a: Any) {
    def show(): Unit =
      a match {
